...
class StartPage(tk.Frame):
        ...
        def __init__(self, parent, controller):
            ...
            button1.place(relx=0.32, rely=0.35, height=31, width=80)
            button2.place(relx=0.1, rely=0.35, height=31, width=80)
...
class PageTwo(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.dropdown1.config(bg="lightgrey")
        self.dropdown2.config(bg="lightgrey")
        self.dropdown3.config(bg="lightgrey")
        self.dropdown4.config(bg="lightgrey")
        self.dropdown1["menu"].config(bg="lightgrey")
        self.dropdown2["menu"].config(bg="lightgrey")
        self.dropdown3["menu"].config(bg="lightgrey")
        self.dropdown4["menu"].config(bg="lightgrey")
