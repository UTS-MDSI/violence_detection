...
# Import classes
from infrastructure.factories.video_frame import tkCamera 
...
class Monitor:
    ...
    def __init__(self, window, window_title, video_sources):
        ...
        """
        Initialise the class for the 3rd window - GUI App
        window: tkinter object
        window_title: title given to the window
        video_sources: list with video names and sources
        """
